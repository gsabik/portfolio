    ...
    return (
        <div className="flex justify-center items-center text-white" id="projects">
            <div className="container m-4">
                <h1 className="text-4xl text-left font-bold" data-aos="fade" data-aos-once="true">Proyectos</h1>
                <div className="w-full grid grid-cols-12 pt-8 lg:space-x-8">
                    <div className="col-span-12 lg:col-span-6">
                        <div className="h-full flex flex-col justify-center" data-aos="fade" data-aos-delay="250" data-aos-once="true">
                    ...
                    <div className="col-span-12 lg:col-span-6">
                        <div className="h-full flex justify-center items-center" data-aos="fade" data-aos-delay="500" data-aos-once="true">
                            <img
                                alt="Lisa Showroom"
                ...
                <div className="flex justify-center pt-12">
                    <a href="https://github.com/gsabik" className="font-semibold border-2 border-white px-4 py-1 rounded-md" rel="noreferrer" target="_blank" data-aos="fade-right" data-aos-delay="750" data-aos-duration="1500" data-aos-once="true">Ver más</a>
                </div>
            </div>
        </div>
    )
