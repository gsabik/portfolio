        ...
        <div className="h-screen flex justify-center items-center">
            <div className="container">
                <div className="w-full grid grid-cols-12">
                    <div className="col-start-1 col-end-7 space-y-4" data-aos="fade">
                        ...
                        <div className="flex flex-row pt-4 space-x-4">
                            <Link to="contact" smooth={true} className="text-white font-semibold border-2 border-white px-6 py-2 rounded-md">Contacto</Link>
                            <Link to="projects" smooth={true} className="font-semibold bg-white px-6 py-2 rounded-md">Proyectos</Link>
                        </div>
                    </div>
                    <div className="col-start-9 col-end-12" data-aos="fade" data-aos-delay="250">
                        <img 
                            alt="Profile Photo" 
